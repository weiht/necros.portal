 ...
 *       &lt;sequence>
 *         &lt;element name="script" type="{http://portal.necros.org/scripts}ScriptType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ScriptsType", namespace = "http://portal.necros.org/scripts", propOrder = {
    "script"
})
public class ScriptsType {

    @XmlElement(namespace = "http://portal.necros.org/scripts")
