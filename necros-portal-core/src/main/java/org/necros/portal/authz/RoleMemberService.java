...
public interface RoleMemberService {
	...
	public abstract RoleMember addMember(String roleId, String personId);
	public abstract void removeMember(String roleId, String personId);
	public abstract RoleMember remove(String roleId, String personId);
